class SetHoldoffComponent extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        this.innerHTML = `
            <div>
                <div class="field">
                    <label class="label">Set X Value</label>
                    <div class="control">
                        <div class="level">
                            <p>${this.minValue}</p>
                ...
                <div class="field">
                    <label class="label">Set Y Value</label>
                    <div class="control">
                        <div class="level">
                            <p>${this.minValue}</p>
                ...
                <button class="button is-primary">Send Holdoff Values</button>
            </div>
        `;
    }
...
customElements.define('set-holdoff-component', SetHoldoffComponent);
